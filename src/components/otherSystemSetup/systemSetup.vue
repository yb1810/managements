                        ...
                        <div class="layui-form" wid100="" lay-filter="">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="sitename" value="layuiSms" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item layui-form-text">
                                ...
                                <div class="layui-input-block">
                                    <textarea name="title" class="layui-textarea">layuiSms 通用后台管理模板系统</textarea>
                                </div>
                            </div>
                            <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-form-item layui-form-text">
                                ...
                                <div class="layui-input-block">
                                    <textarea name="descript" class="layui-textarea">是目前非常流行的后台模板框架，广泛用于各类管理平台。</textarea>
                                </div>
                            </div>
                            <div class="layui-form-item layui-form-text">
                                <label class="layui-form-label">版权信息</label>
                                <div class="layui-input-block">
                                    <textarea name="copyright" class="layui-textarea">© 2018 </textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <div class="layui-input-block">
